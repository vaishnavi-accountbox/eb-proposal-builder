...
import CarousalStyleSettings from './style-components/carousalStyleSettings.vue';
import NavlinkStyleSettings from './style-components/navlinkStyleSettings.vue';
import StyleClickAction from './style-components/styleClickAction.vue';
...
Vue.component('carousal-style-settings', CarousalStyleSettings);

Vue.component('navlink-style-settings', NavlinkStyleSettings);

Vue.component("style-click-action", StyleClickAction);
